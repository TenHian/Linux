- [基本上手](#基本上手)
  - [换源](#换源)
    ...
    - [Kali换源](#kali换源)
    - [CentOS8换源](#centos8换源)
    - [debian11 换源](#debian11-换源)
  - [安装vmtools](#安装vmtools)
  - [设置root用户密码](#设置root用户密码)
  - [nano的使用](#nano的使用)
  - [Vim](#vim)
    - [显示行号](#显示行号)
    - [VIM与系统剪贴板的复制粘贴](#vim与系统剪贴板的复制粘贴)
      - [前提](#前提)
      - [配置](#配置)
    - [vim 使用详解](#vim-使用详解)
  - [Kali自带的截屏功能](#kali自带的截屏功能)
  - [删除、安装、更换内核](#删除安装更换内核)
    - [查看当前正在使用的内核](#查看当前正在使用的内核)
    - [查看还有那些内核](#查看还有那些内核)
    - [删除多余的内核文件](#删除多余的内核文件)
    - [更新grub文件](#更新grub文件)
  - [下载并配置plank](#下载并配置plank)
    - [安装plank](#安装plank)
    - [在Tweak中startup加入plank](#在tweak中startup加入plank)
    - [关闭Ubuntu自带的Ubuntu Dock](#关闭ubuntu自带的ubuntu-dock)
    - [重启](#重启)
- [各种软件的安装](#各种软件的安装)
  - [DOSBOX汇编环境搭建](#dosbox汇编环境搭建)
  - [sublime text3 安装](#sublime-text3-安装)
  - [Kali配置proxychains实现科学上网](#kali配置proxychains实现科学上网)
    - [说明](#说明)
    - [安装proxychains](#安装proxychains)
    - [修改配置文件](#修改配置文件)
    - [安装并配置tor](#安装并配置tor)
    - [设置tor开机自启](#设置tor开机自启)
  - [另一种道路----clashy](#另一种道路----clashy)
    - [下载](#下载)
  - [Kali配置Nessus实现漏洞扫描](#kali配置nessus实现漏洞扫描)
    - [Nessus下载与安装](#nessus下载与安装)
  - [Kali安装中文输入法](#kali安装中文输入法)
    - [安装输入法框架](#安装输入法框架)
    - [安装谷歌输入法](#安装谷歌输入法)
  - [安装VScode](#安装vscode)
  - [安装chrome](#安装chrome)
  - [zsh以及oh-my-zsh配置](#zsh以及oh-my-zsh配置)
    - [查看当前shell](#查看当前shell)
    - [查看系统已经安装的shell](#查看系统已经安装的shell)
    - [安装zsh](#安装zsh)
    - [将默认shell改为zsh](#将默认shell改为zsh)
    - [安装oh-my-zsh](#安装oh-my-zsh)
    - [安装插件](#安装插件)
    - [使配置生效](#使配置生效)
  - [安装typroa](#安装typroa)
    - [配置typora图床](#配置typora图床)
- [Ubuntu的各种命令](#ubuntu的各种命令)
  - [ifconfig命令](#ifconfig命令)
  - [aptitude -- Debian Linux系统中包管理工具](#aptitude----debian-linux系统中包管理工具)
    - [语法](#语法)
    - [选项](#选项)
    - [常用实例](#常用实例)
  - [apt-get](#apt-get)
  ...
  - [dpkg](#dpkg)
    - [说明](#说明-1)
    - [实例](#实例)
- [Ubuntu出的一些问题](#ubuntu出的一些问题)
  - [Kali使用不了 add-apt-repository 命令](#kali使用不了-add-apt-repository-命令)
- [服务器配置](#服务器配置)
- [xshell快捷键](#xshell快捷键)
# 基本上手
## 换源
